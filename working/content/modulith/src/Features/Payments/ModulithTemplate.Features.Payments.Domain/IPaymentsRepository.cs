...
/// <summary>
/// Repository abstraction for the Payments feature. The per-feature interface is what binds the
...
public interface IPaymentsRepository<T> : IRepository<T> where T : class;
